...
public class PCCJob {
    public static void main(String[] args) {
        try {
            ...
            Job job = Job.getInstance(conf, "pearson's correlation coefficient job");

            /* Current class */
            job.setJarByClass(PCCJob.class);

            /* Mapper class */
            job.setMapperClass(PCCMapper.class);
...
//            job.setCombinerClass(ExtremesReducer.class);
            ...
            /* Reducer class */
            job.setReducerClass(PCCReducer.class);
